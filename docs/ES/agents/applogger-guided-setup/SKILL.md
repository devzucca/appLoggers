...
8. When `appLogger.debug=true`, AppLogger outputs automatically to Logcat — do not instruct the user to add any additional Logcat or logging configuration.
9. Never set `appLogger.debug=true` in production builds.
